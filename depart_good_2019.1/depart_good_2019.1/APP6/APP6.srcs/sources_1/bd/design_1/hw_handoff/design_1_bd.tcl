...
proc create_hier_cell_DSP_0 { parentCell nameHier } {
  ...
  connect_bd_net -net Delai_1_Cycle_2_Q [get_bd_pins Interrupt] [get_bd_pins Delai_1_Cycle_2/Q]
  connect_bd_net -net Delai_1_Cycle_Q [get_bd_pins Delai_1_Cycle_1/Q] [get_bd_pins Delai_1_Cycle_2/D]
  connect_bd_net -net Registre_Decalage_Q [get_bd_pins Somme] [get_bd_pins c_addsub_0/B] [get_bd_pins c_addsub_0/S]
  connect_bd_net -net SCLR_1 [get_bd_pins SCLR] [get_bd_pins c_addsub_0/SCLR]
  connect_bd_net -net in1_1 [get_bd_pins in1] [get_bd_pins c_addsub_0/A]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins CLK] [get_bd_pins Delai_1_Cycle_1/CLK] [get_bd_pins Delai_1_Cycle_2/CLK] [get_bd_pins c_addsub_0/CLK]
  connect_bd_net -net myip_0_o_data_available [get_bd_pins CE] [get_bd_pins Delai_1_Cycle_1/D] [get_bd_pins c_addsub_0/CE]
...
# Hierarchical cell: Calculs
proc create_hier_cell_Calculs { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_Calculs() - Empty argument(s)!"}
     return
  }
  ...
  # Create port connections
  connect_bd_net -net DSP_0_Interrupt [get_bd_pins Interrupt] [get_bd_pins DSP_0/Interrupt]
  connect_bd_net -net SCLR_1 [get_bd_pins SCLR] [get_bd_pins DSP_0/SCLR]
  connect_bd_net -net c_addsub_0_S [get_bd_pins DSP_0/Somme] [get_bd_pins myip_0/i_somme_data]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins CLK] [get_bd_pins DSP_0/CLK] [get_bd_pins myip_0/s00_axi_aclk]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins s00_axi_aresetn] [get_bd_pins DSP_0/s00_axi_aresetn] [get_bd_pins myip_0/s00_axi_aresetn]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins myip_0/i_dummy_data] [get_bd_pins xlconstant_1/dout]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: Calculs
  create_hier_cell_Calculs [current_bd_instance .] Calculs
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins Calculs/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M00_AXI]
  ...
  # Create port connections
  connect_bd_net -net Calculs_Interrupt [get_bd_pins Calculs/Interrupt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net INT_NIC100_1 [get_bd_ports INT_NIC100] [get_bd_pins xlconcat_0/In1]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins Calculs/CLK] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_quad_spi_0/s_axi4_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk]
  connect_bd_net -net reset_0_1 [get_bd_ports reset] [get_bd_pins rst_clk_wiz_1_100M/ext_reset_in]
  connect_bd_net -net rst_clk_wiz_1_100M_bus_struct_reset [get_bd_pins microblaze_0_local_memory/SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/bus_struct_reset]
  connect_bd_net -net rst_clk_wiz_1_100M_interconnect_aresetn [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins rst_clk_wiz_1_100M/interconnect_aresetn]
  connect_bd_net -net rst_clk_wiz_1_100M_mb_reset [get_bd_pins microblaze_0/Reset] [get_bd_pins rst_clk_wiz_1_100M/mb_reset]
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins Calculs/s00_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi4_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_reset [get_bd_pins Calculs/SCLR] [get_bd_pins rst_clk_wiz_1_100M/peripheral_reset]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x41200000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_intc_0/S_AXI/Reg] SEG_axi_intc_0_Reg
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x44A10000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs Calculs/myip_0/S00_AXI/S00_AXI_reg] SEG_myip_0_S00_AXI_reg
