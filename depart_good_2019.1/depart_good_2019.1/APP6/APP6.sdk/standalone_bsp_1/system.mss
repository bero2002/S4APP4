...
BEGIN PROCESSOR
 ...
 PARAMETER compiler_flags =  -mlittle-endian -mno-xl-soft-mul -mhard-float -mxl-float-convert -mxl-float-sqrt -mno-xl-soft-div -mcpu=v11.0
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = Calculs_myip_0
END
