...
#define INTC_DEVICE_ID			XPAR_CALCULS_MYIP_0_DEVICE_ID
#define MY_IP_BASE_ADDRESS     	XPAR_CALCULS_MYIP_0_S00_AXI_BASEADDR
...
{
	XIntc_Acknowledge(&InterruptController, XPAR_AXI_INTC_0_CALCULS_DSP_0_DELAI_1_CYCLE_2_Q_INTR);
	...
	// lire la valeur courante dans le registre 1 de myIP
	Whatsthis_ =  MYIP_mReadReg(MY_IP_BASE_ADDRESS, MYIP_REG_1);
	xil_printf("Bizarre = %d\n\r", Whatsthis_);
...
int SetupInterruptSystem()
{
	 ...
	 */
	Status = XIntc_Connect(&InterruptController, XPAR_AXI_INTC_0_CALCULS_DSP_0_DELAI_1_CYCLE_2_Q_INTR,
	...
	XIntc_Enable(&InterruptController, XPAR_AXI_INTC_0_CALCULS_DSP_0_DELAI_1_CYCLE_2_Q_INTR);
